    ...
    <div class="action-bar no-print">
        ...
        <div style="display: flex; gap: 12px; flex-wrap: wrap;">
            ...
            @if(!$procurementRequest->signed_at)
                <button class="btn" style="background: #7c3aed; color: white;" onclick="openSignatureModal()">
                    <i class="ph ph-pen-nib"></i> Assinar Digitalmente
                </button>
            @else
                <a class="btn" style="background: #059669; color: white; text-decoration: none;" href="{{ asset('storage/' . $procurementRequest->signed_file_path) }}" target="_blank">
                    <i class="ph ph-seal-check"></i> Ver Doc. Assinado
                </a>
            @endif
        </div>
    </div>
